...
import { fetchSummaryData } from '../../actions/summary';
        ...
        <div className="row">
				...
				<div className="col-md-3 col-sm-6">
					<div className="widget widget-stats bg-purple">
						...
						<div className="stats-info">
							<h4>Linux Environment</h4>
							<p> { this.props.uniqueVisitors } </p>	
						</div>
						<div className="stats-link">
							{/*<a href="javascript:;">View Detail <i className="fa fa-arrow-circle-o-right"></i></a>*/}
							<Link to='/env'>View Detail <i className="fa fa-arrow-circle-o-right"></i></Link>
						</div>
					</div>
				</div>
