...
import { fetchMainChartData , deleteLineChart } from '../../actions/summary.js';
...
class Trend extends React.Component {
  ...
  componentDidUpdate(prevProps) {
        ...
        if(prevProps.pv && prevProps.pv === this.props.pv) {
            return
        }

        this.renderChart(this.props.pv, this.props.uv, this.props.legends)
                ...
                <div className="col-md-12">
                    <div className="panel panel-inverse" data-sortable-id="index-1">
                            ...
                            <div className="panel-footer text-right">
                                <a href="/api/export/uv" className="btn btn-info btn-sm">Export UV</a>
                                <a href="/api/export/pv" className="btn btn-primary btn-sm m-l-5">Export PV</a>
                            </div>
                    </div>
                </div>
            </div>
